<?php
/**
 * Script de seed : insérer les données initiales dans la table certificat
 * via PDO avec encodage UTF-8 correct.
 */
...
$db->exec("DROP TABLE IF EXISTS certificat");
$db->exec("
...
$stmt = $db->prepare("INSERT INTO certificat (norme, titre, description, organisme) VALUES (:norme, :titre, :description, :organisme)");
...
echo "Seed terminé avec succès ! " . count($data) . " certifications insérées.\n";
?>
