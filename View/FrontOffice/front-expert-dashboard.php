...
<head>
    ...
    <style>
        ...
        .data-table th { color: var(--gray); font-weight: 500; font-size: 0.9rem; }
    </style>
</head>
<body>
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="top-navbar fade-in-up">
                <div>
                    <h2 style="margin: 0; font-size: 1.8rem; color: var(--dark);">Bonjour, Alice <span style="font-size:1.5rem;">🎯</span></h2>
                    <p style="color:var(--gray); font-size:0.9rem;">Voici un aperçu de votre activité d'expert consultant.</p>
                </div>
            </div>
            ...
            <section class="fade-in-up delay-1">
                <div class="stat-grid">
                    <div class="stat-card hover-zoom interactive-card">
                        ...
                        <div><h3 style="font-size: 1.5rem;">7</h3><p style="color: var(--gray); font-size: 0.9rem;">Candidatures envoyées</p></div>
                    </div>
                    <div class="stat-card hover-zoom interactive-card">
                        <div class="stat-icon" style="background: rgba(16,185,129,0.1); color: var(--success);"><i class="fa-solid fa-handshake"></i></div>
                        <div><h3 style="font-size: 1.5rem;">3</h3><p style="color: var(--gray); font-size: 0.9rem;">Missions en cours</p></div>
                    </div>
                    <div class="stat-card hover-zoom interactive-card">
                        <div class="stat-icon" style="background: rgba(245,158,11,0.1); color: var(--warning);"><i class="fa-solid fa-clock"></i></div>
                        <div><h3 style="font-size: 1.5rem;">2</h3><p style="color: var(--gray); font-size: 0.9rem;">En attente de réponse</p></div>
                    </div>
                </div>
                ...
                <div class="card interactive-card hover-zoom" style="display: flex; justify-content: space-between; align-items: center; border-left: 4px solid var(--success); background: linear-gradient(90deg, white, #ecfdf5);">
                    <div>
                        ...
                        <p style="color: var(--gray); font-size: 0.95rem;">Votre candidature pour <strong>"Audit RGPD Complet"</strong> chez TechCorp SAS a été <strong style="color:var(--success);">acceptée</strong> !</p>
                    </div>
                    <a href="front-expert-messagerie.php" class="btn btn-outline" style="border-color: var(--success); color: var(--success);">Contacter l'entreprise</a>
                </div>
