        ...
        <main class="main-content">
            ...
            <section class="fade-in-up">
                <div class="card hover-zoom interactive-card">
                    <p class="mb-1" style="color: var(--gray);">Remplissez votre portfolio avec vos projets et compétences clés pour de meilleures recommandations.</p>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
                        <div class="card" style="border: 1px solid var(--gray-light); box-shadow: none;">
                            <h4 class="mb-1"><i class="fa-solid fa-shield-halved text-primary"></i> Compétence : Cybersécurité</h4>
                            <div style="background: #e2e8f0; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="background: var(--primary); height: 100%; width: 85%; transition: width 1s ease;"></div>
                            </div>
                            <span style="font-size:0.8rem; color:var(--gray);">Niveau Avancé</span>
                        </div>
                        <div class="card" style="border: 1px solid var(--gray-light); box-shadow: none;">
                            <h4 class="mb-1"><i class="fa-solid fa-certificate text-primary"></i> Projet : Certification 27001</h4>
                            <p style="font-size:0.9rem; color: var(--gray);">Accompagnement d'une PME dans la mise en place de l'ISO 27001.</p>
