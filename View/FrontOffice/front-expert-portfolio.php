    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="top-navbar">
                <h2 style="margin: 0; font-size: 1.5rem;">Portfolio & CV</h2>
                <button class="btn btn-primary"><i class="fa-solid fa-plus"></i> Ajouter Projet / Compétence</button>
            </div>
            <section class="fade-in-up">
                <div class="card hover-zoom interactive-card">
                    <p class="mb-1" style="color: var(--gray);">Enrichissez votre portfolio pour renforcer vos candidatures et attirer les entreprises.</p>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
                        <div class="card" style="border: 1px solid var(--gray-light); box-shadow: none;">
                            <h4 class="mb-1"><i class="fa-solid fa-shield-halved text-secondary"></i> Compétence : Cybersécurité</h4>
                            <div style="background: #e2e8f0; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="background: var(--secondary); height: 100%; width: 90%; transition: width 1s ease;"></div>
                            </div>
                            <span style="font-size:0.8rem; color:var(--gray);">Niveau Expert (90%)</span>
                        </div>
                        <div class="card" style="border: 1px solid var(--gray-light); box-shadow: none;">
                            <h4 class="mb-1"><i class="fa-solid fa-certificate text-secondary"></i> Projet : Certification ISO 27001</h4>
                            <p style="font-size:0.9rem; color: var(--gray);">Accompagnement d'une PME dans la mise en place de l'ISO 27001. Durée: 4 mois.</p>
                            <span class="badge success mt-1">Réalisé</span>
                        </div>
                        <div class="card" style="border: 1px solid var(--gray-light); box-shadow: none;">
                            <h4 class="mb-1"><i class="fa-solid fa-magnifying-glass-chart text-secondary"></i> Projet : Audit RGPD FinTech</h4>
                            <p style="font-size:0.9rem; color: var(--gray);">Audit complet de conformité RGPD pour une startup FinTech avec 500K utilisateurs.</p>
                            <span class="badge success mt-1">Réalisé</span>
                        </div>
                    </div>
                </div>
